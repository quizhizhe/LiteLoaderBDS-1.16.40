...
public:
    ...
    /*3*/ virtual std::vector<struct ResourcePath> loadAllVersionsOf(class ResourceLocation const &) const;
    /*4*/ virtual bool isInStreamableLocation(class ResourceLocation const &) const;
    /*5*/ virtual bool isInStreamableLocation(class ResourceLocation const &, std::vector<std::string> const &) const;
    ...
    /*10*/ virtual bool hasCapability(class gsl::basic_string_span<char const, -1>) const;
