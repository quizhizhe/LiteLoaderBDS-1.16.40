...
//private:
    ...
    MCAPI void _placeTopDecorations(class BlockSource &, class BlockPos const &, class Random &) const;
    MCAPI class gsl::not_null<class Block const *> _setCoralHangData(int, int, int) const;
