...
public:
    ...
    /*1*/ virtual void onRedstoneUpdate(class BlockSource &, class BlockPos const &, int, bool) const;
    ...
    /*165*/ virtual void updateShape(class BlockSource &, class BlockPos const &);
    /*166*/ virtual void updateSignalStrength(class BlockSource &, class BlockPos const &) const;
