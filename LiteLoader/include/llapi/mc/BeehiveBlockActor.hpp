...
//private:
    MCAPI std::vector<unsigned char> _findFreeDirections(class BlockSource &, unsigned char, unsigned __int64);
    MCAPI bool _isUsableAsSpawnBlock(class BlockSource &, unsigned char);
