...
public:
    ...
    /*165*/ virtual int getSignalStrength(class BlockSource &, class BlockPos const &) const;
    /*166*/ virtual int getSignalForData(int) const;
    /*167*/ virtual int getRedstoneSignal(int) const;
