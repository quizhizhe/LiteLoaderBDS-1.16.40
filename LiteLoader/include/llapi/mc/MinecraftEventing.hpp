...
public:
    ...
    MCVAPI void fireEventAssertFailed(std::string &);
    ...
    MCVAPI void fireEventExperimentalGameplay(bool, bool);
    ...
    MCVAPI void fireEventHummingbirdScreenLoadFailed(unsigned int const &, std::string const &, std::string const &);
    ...
    MCVAPI void fireEventPerformanceMetrics(struct ProfilerLiteTelemetry const &);
    MCVAPI void fireEventPersonaAvatarUpdated(std::string const &, std::vector<std::string> const &, std::vector<bool> const &, std::vector<bool> const &, bool, bool, std::string const &, std::string const &, std::string const &, bool);
    ...
    MCVAPI void fireEventPersonaItemPreviewed(std::string const &, std::string const &, unsigned int, unsigned int, enum IMinecraftEventing::PromotionType, bool, enum IMinecraftEventing::StoreType);
    ...
    MCVAPI void fireEventSignInToXboxLive(class Social::XboxLiveUser const &, bool, enum IMinecraftEventing::SignInStage);
    ...
    MCVAPI void fireEventWorldLoaded(class Player *, class Level &, class ResourcePackManager &, struct ResourcePacksInfoData &);
    ...
    MCVAPI void fireStructureBlockLoadedInUnloadedChunks(unsigned int, class BlockPos const &, class BlockPos const &);
    ...
    MCAPI static void fireEventJukeboxUsed(class Player *, class ItemDescriptor const &);
