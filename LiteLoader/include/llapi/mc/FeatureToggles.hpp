...
public:
    ...
    MCAPI ~FeatureToggles();

//private:
    MCAPI void _initialize(class AppPlatform &);
    MCAPI void _registerFeature(enum FeatureOptionID, std::string const &, std::string const &, bool, enum FeatureOptionID, class std::function<void (class Option &)>, class std::function<bool (void)>);
