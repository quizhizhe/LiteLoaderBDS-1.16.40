...
public:
    ...
    /*166*/ virtual class Item const & getBaseCrop() const;
    /*167*/ virtual int getSeedNum(class Random &, int, int, bool) const;
    /*168*/ virtual int getCropNum(class Random &, int, int, bool) const;
