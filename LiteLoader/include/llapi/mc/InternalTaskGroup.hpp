...
public:
    ...
    MCVAPI void requeueTask(class std::shared_ptr<class BackgroundTask>, bool);
    MCVAPI void taskComplete(class gsl::not_null<class BackgroundTask *>);
    MCVAPI void taskRegister(class std::shared_ptr<class BackgroundTask>);
#endif
